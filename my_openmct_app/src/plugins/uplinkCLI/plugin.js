...
const HELP = {
    ...
    recovery: [
        ...
        '  2=PARSER_RESET(mavlink_bridge_app 파서만 리셋), 3=SERIAL_RECONNECT(mavlink_bridge_app',
        '  시리얼만 재연결), 4=RESTART_UPLINK, 5=RESTART_LORA (2026-07-21 BL-09,',
        '  2026-07-22 PARSER_RESET/SERIAL_RECONNECT 실배선). byte[1]/byte[2]는 여전히',
